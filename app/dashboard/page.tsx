...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* アップグレード誘導（無料プランの場合） */}
      {planName === 'free' && (
        <div className="bg-gradient-to-r from-[#171158] to-[#1B1723] rounded-2xl p-5 text-white">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-bold text-[#E6A24C]">Personal ¥499/月</span>
              </div>
              <h3 className="text-lg font-bold mb-2">もっと便利に使おう</h3>
            ...
            <Link
              href="/dashboard/settings/billing"
              className="shrink-0 px-6 py-3 text-sm font-bold text-[#171158] bg-[#E6A24C] rounded-xl hover:bg-[#F0B86E] transition-colors shadow-lg"
            >
              アップグレード
            </Link>
          </div>
